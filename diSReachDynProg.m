...
disp('Case 1: Stochastic viability problem');
...
zlabel('time');
title('Safety tube');
saveas(gcf, '../results/1_safety_tube.png')
%%
...
box on
view(45, 45)
saveas(gcf, '../results/1_opt_value_fn.png')
%%
...
saveas(gcf, '../results/1_stoch_reach_set.png')

%% Case 2: Terminal hitting-time stochastic reach-avoid 
disp('Case 2: Terminal hitting-time stochastic reach-avoid');
...
zlabel('time');
title('Safety tube');
saveas(gcf, '../results/2_safety_tube.png')
%%
...
view(45, 45)
title('Optimal value function $V_{SR}^\ast(\cdot)$','interpreter','latex');
saveas(gcf, '../results/2_opt_value_fun.png')
%%
...
saveas(gcf, '../results/2_stoch_reach_set.png')
%%

%% Case 3: Time-varying safety sets (Stochastic reachability of a target tube)
disp('Case 3: Time-varying safety sets (Stochastic reachability of a target tube)');
...
title('Safety tube');
view([-25 60]);
saveas(gcf, '../results/3_safety_tube.png')
%%
...
view(45, 45)
title('Optimal value function $V_{SR}^\ast(\cdot)$','interpreter','latex');
saveas(gcf, '../results/3_opt_value_fun.png')
%%
...
saveas(gcf, '../results/3_stoch_reach_set.png')